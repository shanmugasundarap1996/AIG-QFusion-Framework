...
# -*- coding: utf-8 -*-
"""
AIG-QFusion proposed system for PCA-12 only.

Example:
python proposed_pca12.py \
  --data-root ./data/dataset_saved_500_300_pca4to12 \
  --dataset balanced \
  --out-dir ./outputs/aigqfusion_pca12
"""
...
def main() -> None:
    ...
    Xtr_raw, ytr, Xte_raw, yte = load_train_test(args.data_root, args.dataset, args.pca, args.label_col)
    ...
    raw_df.to_csv(out_dir / "raw_all_seeds_aigqfusion_balanced_pca12.csv", index=False)
    ...
    mean_df.to_csv(out_dir / "mean_aigqfusion_balanced_pca12.csv", index=False)
    std_df.to_csv(out_dir / "std_aigqfusion_balanced_pca12.csv", index=False)
    highlight_and_export(mean_df, std_df, out_dir, "aigqfusion_balanced_pca12")
